<aside class="w-64 fixed h-screen bg-slate-900 border-r border-gray-700 shadow-2xl">
    <div class="p-1">
        ...
        <nav class="mt-8 space-y-1.5">
            ...
            <a href="#" class="flex items-center gap-3 p-3.5 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800 rounded-xl transition-all duration-200">
