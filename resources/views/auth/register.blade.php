    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-slate-800 p-8 rounded-xl border border-slate-700 shadow-xl">
            <div class="text-center">
                ...
                <h2 class="text-xl font-semibold text-slate-200">Create New Account</h2>
            </div>
            ...
            <form class="mt-8 space-y-6" method="POST" action="#">
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-300">Middle Name</label>
                ...
                <p class="text-center text-sm text-slate-400">
                    ...
                    <a href="/login" class="font-medium bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent hover:from-blue-300 hover:to-cyan-300">
                        Login here
                    </a>
                </p>
            </form>
